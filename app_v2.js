...
if (submitBtn) {
    submitBtn.addEventListener('click', async (e) => {
        ...
        const requiredIds = ['ContentPlaceHolder1_ddlBank', 'ContentPlaceHolder1_txtATMID', 'ContentPlaceHolder1_txt_atmplace', 'txtActualDateTime', 'fromtime', 'txt_todate', 'txt_totime', 'txt_ack_fir_no', 'ContentPlaceHolder1_uploadnotice'];
        for (let id of requiredIds) {
            const el = document.getElementById(id);
            if (el && (!el.value || (el.files && el.files.length === 0))) {
